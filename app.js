...
const colors = {
  deepColor: new THREE.Color(0x1a0d00),
  baseColor: new THREE.Color(0x3f2a00),
  mainColor: new THREE.Color(0xb8860b),
  accentColor: new THREE.Color(0xffd700),
  highlightColor: new THREE.Color(0xffe4b5)
};
...
function onMouseDown() {
  ...
  flashElement.style.backgroundColor = `rgba(255, 215, 0, 0.15)`;
